...
whitelist = %w[context.matcher.service]
file_path = "apps/transport/matcher_request.rb"
...
whitelist = %w[context.shop.service]
file_path = "apps/transport/shop_request.rb"
